...
class Controller
{
    ...
    public function loadView($view_name, $layout = true)
    {
        if($layout){require 'application/views/_templates/header.php';}
        require 'application/views/' . $view_name . '.php';
        if($layout){require 'application/views/_templates/footer.php';}
    }
